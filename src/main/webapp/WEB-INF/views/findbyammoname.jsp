...
<main id="main" class="main">
    ...
    <div class="pagetitle">
        <h1>Podaj nazwę amunicji którą chcesz zmienić </h1>
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Wybierz amunicję której dane chcesz zmienić i wpisz jej id</h5>
                        <div  class="col-md-4">
                            <form class="row g-3" action="/findbyammoname" method="post"  >
