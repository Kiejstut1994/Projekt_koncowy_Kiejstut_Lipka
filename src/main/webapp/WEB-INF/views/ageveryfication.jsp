...
<!-- ======= Header ======= -->
<header id="header" class="visually-hidden-focusable">
...
<!-- ======= Sidebar ======= -->
<aside id="sidebar" class="visually-hidden-focusable">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                ...
                <li>
                    <a href="forms-editors.html">
                        <i class="bi bi-circle"></i><span>Do strzelby</span>
                    </a>
                </li>
                <li>
                    <a href="forms-validation.html">
                        <i class="bi bi-circle"></i><span>Do rewolweru</span>
                    </a>
                </li>
                <li>
                    <a href="forms-validation.html">
        ...
        <!--          <i class="bi bi-gem"></i><span>Szafy na broń</span><i class="bi bi-chevron-down ms-auto"></i>-->
        <!--        </a>-->
        <!--        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">-->
        <!--          <li>-->
        <!--            <a href="icons-bootstrap.html">-->
        <!--              <i class="bi bi-circle"></i><span>Szafy na broń</span>-->
        <!--            </a>-->
        <!--          </li>-->
        <!--          <li>-->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Czy jesteś pełnoletni ?</h5>
                        <button type="button" class="btn btn-danger"><a href="https://www.google.com/"> Wracam do bezpiecznej strony</a></button>
                                                <button type="button" class="btn btn-info"><a href="/mainview/true"> Przechodzę dalej</a></button>
                    </div>
                </div>
